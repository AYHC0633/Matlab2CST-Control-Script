...
%             NResults = length(RunIDs);
    ...
    methods
        ...
        % otherwise, open CST
        % -----------------------------------------------------------------
        function ConnectToCSTOrStartIt(this,Version)
        % @DESCRIPTION
        ...
        % Obj.ConnectToCSTOrStartIt();
            ...
            try
                this.FApp = actxGetRunningServer(['CSTStudio.Application' '.' num2str(Version)]);
            catch % we are here if there is no running CST
                this.FApp = actxserver(['CSTStudio.Application' '.' num2str(Version)]);
            end
        end
        ...
        % -----------------------------------------------------------------
        function OpenProject(this, FullFileName,Version)
        % @DESCRIPTION
        ...
        % @ARG FileName - a \code{.cst}-file to open. Can contain absolute or relative path. 
            ...
            if isempty(this.FApp),
                this.ConnectToCSTOrStartIt(Version);
            end
       ...
       %-----------------------------------------------%
        %### 2020 version of opening up file (customfile add-on) #######%
        %-----------------------------------------------%
         function ConnectToCSTOrStartIt2020(this)
            % try to get already opened CSR
            try
                this.FApp = actxGetRunningServer('CSTStudio.Application.2020');
            catch % we are here if there is no running CST
                this.FApp = actxserver('CSTStudio.Application.2020');
            end
         end

           function OpenProject2020(this, FullFileName)
            if nargin<2,  FullFileName = [];  end
            ...
            % Assign this.FApp if CST is opened, or start it first if not  
            if isempty(this.FApp),
                this.ConnectToCSTOrStartIt2020();
            end
